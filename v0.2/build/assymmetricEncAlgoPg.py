...
backButton = Button(window, text = "<", font = ("Ubuntu_Mono_Bold_Italic bold", 13), fg = "white",
    height = 2, width = 7, bg = "#000369", command = lambda: back(), cursor = "exchange"
    )
backButton.place(x = 0, y = 0)

#User Input Text Area
userInput = Text(window, height = 9, width = 133, bg = "#001220", borderwidth = 0, 
...
#Output Text Area
textOutput = Text(window, height = 9, width = 133, bg = "#001220", borderwidth = 0, 
    fg = "white", padx = 2, pady = 2, cursor = "spider"
    )
...
generateButton = Button(window, text = "Generate", font = "Ubuntu_Mono_Bold_Italic 9 bold", fg = "white",
    height = 3, width = 15, bg = "#001220", command = lambda: diffieHelmanCheck(), cursor = "pirate"
    )
...
encryptButton = Button(window, text = "Encrypt", font = "Ubuntu_Mono_Bold_Italic 9 bold", fg = "white",
    height = 3, width = 30, bg = "#001220", command = lambda: encrypt(), cursor = "pirate"
    )
encryptButton.place(x = 671, y = 379)

#Decrypt Button
decryptButton = Button(window, text = "Decrypt", font = "Ubuntu_Mono_Bold_Italic 9 bold", fg = "white",
    height = 3, width = 30, bg = "#001220", command = lambda: decrypt(), cursor = "pirate"
    )
...
combostyle.theme_create('combostyle', parent='alt',
                         settings = {'TCombobox':
                                     {'configure':
                                      {'selectbackground': '#001220',
                                       'fieldbackground': '#001220',
                                       'background': 'white',
                                       'borderwidth': 10,
                                       }}}
                         )
