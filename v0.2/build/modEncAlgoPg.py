...
backButton = Button(window, text = "<", font = ("Ubuntu_Mono_Bold_Italic bold", 13), fg = "black",
    height = 2, width = 7, bg = "#003D5C", command = lambda: back(), cursor = "exchange"
    )
backButton.place(x = 0, y = 0)

#User Input Text Area
userInput = Text(window, height = 9, width = 133, bg = "#003D5C", borderwidth = 0, 
...
#Output Text Area
textOutput = Text(window, height = 9, width = 133, bg = "#003D5C", borderwidth = 0, 
    fg = "white", padx = 2, pady = 2, cursor = "spider"
    )
...
encryptButton = Button(window, text = "Encrypt", font = "Ubuntu_Mono_Bold_Italic 9 bold", fg = "white",
    height = 3, width = 30, bg = "#003D5C", command = lambda: encrypt(), cursor = "pirate"
    )
encryptButton.place(x = 671, y = 379)

#Decrypt Button
decryptButton = Button(window, text = "Decrypt", font = "Ubuntu_Mono_Bold_Italic 9 bold", fg = "white",
    height = 3, width = 30, bg = "#003D5C", command = lambda: decrypt(), cursor = "pirate"
    )
